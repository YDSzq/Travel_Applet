<template>
	<view>
		...
		<view class="footer">
			<view class="footer-item" v-for="(item,index) in items" :key="index" @click="newNav" :data-page="item.text" :style="'width:'+ 100/Object.keys(items).length +'%;'"
			 :class="pages==item.text?'footer_this':''">
